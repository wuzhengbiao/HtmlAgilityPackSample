 ...
 */
public class DingDingSendMessage {
    private static Logger logger = LoggerFactory.getLogger(DingDingSendMessage.class);
    /**
     ...
     * @return
     */
    public static String sendPostByMap(String url, Map<String, Object> mapParam,int isNeedPostFlag) {
        Map<String, String> headParam = new HashMap();
        headParam.put("Content-type", "application/json;charset=UTF-8");
        if(isNeedPostFlag==0)
        {
            return  "No start DingDingMachine !!";
        }
        else{
